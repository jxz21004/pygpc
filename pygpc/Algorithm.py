...
class Algorithm(object):
    ...
    def __init__(self, problem, options, grid=None, validation=None, exGrad=None, exGradSolver=None):
        """
        ...
        # added by jxz
        self.exGrad = exGrad
        self.exGradSolver = exGradSolver
    ...
    def check_basic_options(self):
        ...
        options["gradient_calculation"] : str, optional, default="standard_forward"
            ...
            - "External" : Get gradient value from external solvers such as analytical solver, adjoint solver etc.(added by jxz)
        ...
        options["exGrad_options"]: str, optional, default : "TestFunc"
            Added by jxz. For now there is only one choice for this option.
        ...
        # Added by jxz
        if "exGrad_options" not in self.options.keys():
            self.options["exGrad_options"] = "TestFunc"
...
#################### To Do : to add the Gradenh method in this part
    Examples
    --------
    >>> import pygpc
    ...
    """
    def __init__(self, parameters, options, results, grid, validation=None, exGrad=None, exGradSolver=None):
        """
        ...
        super(Static_IO, self).__init__(problem=problem, options=options, validation=validation, grid=grid, exGrad=exGrad, exGradSolver=exGradSolver)
...
######################### For now only Static is supported 
    ...
    def __init__(self, problem, options, grid=None, validation=None, gpc=None, exGrad=None, exGradSolver=None):
        """
        Constructor; Initializes static gPC algorithm
        """
        super(Static, self).__init__(problem=problem, options=options, validation=validation, grid=grid, exGrad=exGrad, exGradSolver=exGradSolver)
        ...
        while eps > self.options["eps"]:
            ...
            if self.options["gradient_enhanced"]:
                ...
                grad_res_3D, gradient_idx = get_gradient(model=self.problem.model,
                                                         ...
                                                         method=self.options["gradient_calculation"],
                                                         exGrad=self.exGrad,
                                                         exGrad_options=self.options["exGrad_options"],
                                                         exGradSolver=self.exGradSolver,
                                                         gradient_results_present=None,
                                                         gradient_idx_skip=None,
                                                         i_iter=gpc.order_max,
                                                         i_subiter=gpc.interaction_order,
